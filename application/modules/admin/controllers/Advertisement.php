...
class Advertisement extends MY_Controller{
    ...
    public function __construct(){
        ...
        $this->_post_type = POST_TYPE_ADVERTISE_SIGNS;
        $this->_blog_parent_category = PARENT_CAT_ADVERTISE_SIGNS;
    ...
    function index(){
        ...
        $this->_data['breadcrumb'] = $this->lable['advertisement_signs'];
        $this->_data['alert'] = '';
        ...
        if (!empty($id) && $option == 'edit') {
            $this->parser->parse("advertisement/edit.tpl", $this->_data);
        } else {
            $this->parser->parse("advertisement/add.tpl", $this->_data);
        }
    ...
    function add() {
        ...
        if($this->form_validation->run() == FALSE) {
            ...
            $this->parser->parse("advertisement/$tpl", $this->_data);
            return;
        }
        ...
        if (!empty($id) && $option == OPTION_EDIT) { //Update
            ...
            if ($update) {
                ...
                redirect( admin_url("advertisement/items/") );
            } else {
                $this->session->set_flashdata('alert', 'danger');
                $this->session->set_flashdata('msg', $this->lable['edit_fail']);
                redirect( admin_url("advertisement/?id=$id&option=edit") );
            }
        } else { //insert
    ...
    function duplicate() {
        ...
        $back_url = admin_url("advertisement/items");
        ...
        if ($insert) {
            ...
            $this->parser->parse("advertisement/alert.tpl", $this->_data);
    ...
    */
    function items($start=0){
        ...
        */
        ...
        $base_url    = admin_url('advertisement/items');
        $uri_segment = 4;
        ...
        $this->parser->parse("advertisement/items.tpl", $this->_data);
    }
