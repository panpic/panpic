...
class Consulting extends MY_Controller{
    ...
    function index(){
        ...
        if($q != '') {
            $cond = " WHERE a.fullname LIKE'%$q%' OR a.email LIKE '%$q%' OR a.phone LIKE '%$q%' ";
            $search['q'] = $q;
        }
        ...
        $totalItems  = $this->consulting_model->countItem($cond);
        ...
        $items = $this->consulting_model->items($cond, $per_page, $start);
