...
class Doctor extends MY_Controller{
    ...
    public function __construct(){
        ...
        $this->_post_type = POST_TYPE_DOCTOR;
        $this->_blog_parent_category = PARENT_CAT_DOCTOR;
        ...
        $this->_data['POST_TYPE_DOCTOR_GALLERY'] = POST_TYPE_DOCTOR_GALLERY;
    ...
    function index(){
        ...
        $this->_data['breadcrumb'] = $this->lable['menu_doctor'];
        $this->_data['alert'] = '';
    ...
    function add() {
        ...
        if (!empty($id) && $option == OPTION_EDIT) { //Update
            ...
            $params_translate = array(
                ...
                'title_2'     => addslashes($_data[$this->current_lang]['title_2']),
                'short'       => addslashes($_data[$this->current_lang]['short']),
                'content'     => addslashes($_data[$this->current_lang]['content']),
                'content_2'   => addslashes($_data[$this->current_lang]['content_2']),
                'price'       => addslashes($_data[$this->current_lang]['price']),
    ...
    function gallery() {
        error_reporting(E_ALL ^ (E_NOTICE | E_WARNING));
        $post_type = POST_TYPE_DOCTOR_GALLERY;
