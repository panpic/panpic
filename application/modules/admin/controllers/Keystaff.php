...
class Keystaff extends MY_Controller{
    ...
    public function __construct(){
        ...
        $this->_post_type = POST_TYPE_KEY_STAFF;
        $this->_blog_parent_category = PARENT_CAT_KEY_STAFF;
    ...
    function index(){
        ...
        $this->_data['breadcrumb'] = $this->lable['menu_about_key_staff'];
        $this->_data['alert'] = '';
