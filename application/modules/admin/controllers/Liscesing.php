...
class Liscesing extends MY_Controller{
    ...
    public function __construct(){
        ...
        $this->_post_type = POST_TYPE_LISCESING;
        $this->_blog_parent_category = PARENT_CAT_LISCESING;
    ...
    function index(){
        ...
        $this->_data['breadcrumb'] = $this->lable['liscesing'];
        $this->_data['alert'] = '';
