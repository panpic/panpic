...
class Recruitment extends MY_Controller{
    ...
    public function __construct(){
        ...
        $this->_post_type = POST_TYPE_REDCRUITMENT;
        $this->_blog_parent_category = PARENT_CAT_RECRUITMENT;
        ...
        $this->_data['parent_category'] = $this->_blog_parent_category;
    ...
    function index(){
        ...
        $this->_data['breadcrumb'] = $this->lable['recruitment'];
        $this->_data['alert'] = '';
    ...
    function add() {
        ...
        /*
        if($_data['career_effect'] != '' && $_data['career_expire'] != '') {
            $params['career_effect'] = date('Y-m-d', strtotime($_data['career_effect']));
            $params['career_expire'] = date('Y-m-d', strtotime($_data['career_expire']));
        }
        */
