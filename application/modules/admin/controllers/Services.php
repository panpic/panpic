...
class Services extends MY_Controller{
    ...
    public function __construct(){
        ...
        $this->_post_type = POST_TYPE_SERVICES;
        $this->_blog_parent_category = PARENT_CAT_SERVICES;
    ...
    function index(){
        ...
        $this->_data['breadcrumb'] = $this->lable['services'];
        $this->_data['alert'] = '';
        ...
        if (!empty($id) && $option == 'edit') {
            ...
            $data = $this->blogs_model->getItemsMultiLangById($cond_image);
            $first = $data[0];
