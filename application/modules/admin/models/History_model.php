...
class History_model extends MY_Model
{
    ...
    function getItemByCond($cond, $cond_image=" AND c.image_type = 'B' "){
        ...
        $sql = "SELECT a.category_id, a.portfolio_category_id, a.post_type, a.date_add, a.avail, a.admin_verify, b.*, c.image_id, c.path_image, c.path_image_thumb
                FROM $this->_pp_blog AS a 
    ...
    function getItems($cond='', $num='', $offset=''){
        ...
        $sql = "SELECT a.category_id, a.post_type, a.date_add, a.portfolio_year, a.avail, a.admin_verify, b.*, d.cat_name, d.cat_slug, i.path_image, i.path_image_thumb 
    ...
    function builParamsInsert($_data, $lang) {
        ...
        $title_slug = url_convert($_data[$lang]['slug'].'-'.$lang);
        if($this->id) {
