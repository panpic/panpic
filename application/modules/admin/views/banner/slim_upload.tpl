...
<div class="col-md-12 slim logo r-0" data-label="{$lable.image}" data-force-min-size="false" data-min-size="80,50" style='width:248px;height:158px;margin-left:12px;'>
    {if $data.banner_file neq ''}
        <img src="{$link_upload}/{$data.banner_file}" alt="">
    {/if}
