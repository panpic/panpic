...
<div class="purchase-product">					
	<div class="row">
		...
		<div class="form-actions pull-right">
			<h4>&nbsp; </h4>
			<a href="{$base_url_admin}/blogcat/" id="btnAddUser" class="btn btn-primary">{$lable.add_new}</a>
		</div>
		</div>
	...
	<tbody>
		...
		<tr class="gradeX">
			...
			<td class="right right_padding">
				{if $vl.level gt 0}					
				<a href="{$base_url_admin}/{$control}/?id={$vl.post_cat_id}&option=edit" class="btn btn-sm btn-success button_margin" title="Update {$vl.cat_name}"><i class="fa fa-pencil"></i></a>	
				{/if}

				{**
				{if $user_data->adminRole eq 'ADMINISTRATOR' && $vl.level gt 1}
					<a data-toggle="confirmation" data-placement="left" href="javascript:void(0)" data-href="{$base_url_admin}/{$control}/delnested/?id={$vl.post_cat_id}" class="ask btn btn-sm btn-danger button_margin" title="Delete"><i class="fa fa-trash-o"></i></a>
				{/if}
