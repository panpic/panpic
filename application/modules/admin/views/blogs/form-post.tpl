...
<div class="col-md-12">
   ...
   <p class="help-block"></p>
    ...
    <div class="col-md-12">
        ...
        <input type="text" name="tags[]" id="tags" class="col-md-12" value="{if $tags}{foreach from=$tags name=test item=t}{$t.title}{if not $smarty.foreach.test.last},{/if}{/foreach}{/if}" />
    </div>
</div>