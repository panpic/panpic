        ...
        <div class="col-md-9 l-r-0">
            <div class="widget widget-tabs widget-tabs-double widget-tabs-responsive">
                <div class="widget-head">
                    <ul>
                        <li class="active">
                        	<a href="#tab1-2" class="glyphicons circle_plus" data-toggle="tab"><i></i><!--<span><img src="{$base_url}/images/flag/vn.png" /></span>--><span>{$lable.faq}</span></a>
                        </li>
                        {**
