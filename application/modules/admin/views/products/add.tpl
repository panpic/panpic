...
<div class="relativeWrap">
    ...
    <input type="hidden" name="option" id="option" value="{$option}" />
        ...
        <div class="col-md-9 l-r-0">
            <div class="widget widget-tabs widget-tabs-double widget-tabs-responsive">
                <div class="widget-head">
                    <ul>
                        <li class="active">
                        	<a href="#tab1-2" class="glyphicons circle_plus" data-toggle="tab"><i></i><!--<span><img src="{$base_url}/images/flag/vn.png" /></span>--><span>Product</span></a>
                        </li>
                        {**
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="tab1-2">
                            ...
                            <div>
                             ...
                             <div>
                             {include file="products/tabs.tpl"}
                             </div>
                             <div>
        ...
        <div class="col-md-3 widget">
        	{include file="products/right.tpl"}
        </div><!--.col-md-3-->
...
$(document).ready (function(){
    ...
    var editor_full_technical = CKEDITOR.replace('full_technical');
    CKFinder.setupCKEditor( editor_full_technical, '/ckfinder/');
