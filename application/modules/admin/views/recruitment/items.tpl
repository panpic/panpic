                    ...
                    <table class="table list-items table-bordered table-condensed" id="dataTables-member">
                        ...
                        {foreach from=$items item=item}
                            <tr class="parent-status">
                                ...
                                <td>
                                    {$item.career_effect|date_format:"%d-%m-%Y"} - {$item.career_expire|date_format:"%d-%m-%Y"}
                                </td>
                                <td>
...
$(document).ready(function(){ 
    ...
    $('.avail').on('click', function(e) {     
        ...
        $.ajax({
            url: base_url_admin+'/'+current_control+'/update_status/',
            type: 'POST',
    ...
    $('.display-home').on('click', function(e) {     
        ...
        $.ajax({
            url: base_url_admin+'/'+current_control+'/updateVerify',
            type: 'POST',
	...
	$('.show-home').on('click', function(e) {     
        ...
        $.ajax({
            url: base_url_admin+'/'+current_control+'/show_home',
            type: 'POST',
