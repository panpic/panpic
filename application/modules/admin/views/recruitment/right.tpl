<input type="hidden" name="data[category_id]" id="category_id" value="{$parent_category}" />
...
**}
<div class="row" style="padding-top:10px;">
    <label class="col-md-12">THỜI GIAN ỨNG TUYỂN</label>
    <div class="col-md-12">
        <input type="text" name="data[career_effect]" id="career_effect" class="form-control" value="{$data.career_effect}" placeholder="Từ ngày" /> -
        <input type="text" name="data[career_expire]" id="career_expire" class="form-control" value="{$data.career_expire}" placeholder="Tới ngày" />
    </div>
</div>
