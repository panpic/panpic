        ...
        <div class="widget-body innerAll inner-2x">
                <div class="box-search">
                    ...
                    <div class="col-md-2 pull-right text-right">
                    	<a href="{$base_url_admin}/{$control}/add" class="btn btn-primary"><i class="fa fa-plus-circle"></i> {$lable.add_new}</a>
                    </div>
                </div>
                <br />
                    ...
                    <table class="table list-items table-bordered table-condensed" id="dataTables-member">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">{$lable.district}</th>
                                <th class="text-center">{$lable.ward}</th>
                        ...
                        {foreach from=$items item=item}
                            <tr class="parent-status">
                                <td class="check-id">
                                  <input name="checkAll[]" id="check_id" value="{$item.ward_id}" type="checkbox" />
                                </td>
                                ...
                                <td style="text-align:center;">
                                    {if $tab eq $BLOG_TAB_INACTIVE}
                                    	<a href="{$base_url_admin}/{$control}/restore?id={$item.ward_id}" class="btn btn-sm btn-danger button_margin" title="Restore"><i class="fa fa-undo"></i></a>
                                    {else}
                                        <a href="{$base_url_admin}/{$control}/add?id={$item.ward_id}&option=edit" class="btn btn-sm btn-success button_margin" title="Update"><i class="fa fa-pencil"></i></a>
                                        {**
                                        <a href="{$base_url_admin}/{$control}/del?id={$item.ward_id}" class="btn btn-sm btn-danger button_margin" title="Delete"><i class="fa fa-trash-o"></i></a>
                                        **}
                                    {/if}
                                </td>
                            </tr>
