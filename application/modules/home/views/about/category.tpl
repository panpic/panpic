            ...
            <div class="row">
                <div class="col-lg-8 order-lg-1">
                    <div class="heading mt-0">
                        <h1 class="heading-title lh-base h3">{$category.cat_name|stripslashes}</h1>
                    </div>
                    {if $totalItems == 0}
                    ...
                    {else}
                        <div class="row gx-2 gx-sm-3">
                            {foreach from=$news key=$newsKey item=newsItem}
                                {assign var=link value=$newsItem.slug|url_technology_detail:$newsItem.blog_id}
                                {assign var=title value=$newsItem.title|stripslashes}
                                {if $newsKey == 0}
