				...
				<div class="col-lg-8 order-lg-1">
					<article class="single mb-5">
						...
						<div class="single-thumbnail text-center">
                            {if $news.path_image}
								<img src="{$link_upload}/{$news.path_image}" alt="{$news.title|stripslashes}" class="img-fluid">
                            {/if}
						</div>
						**}
								...
								<div class="col-12 mb-3">
									<div class="row gx-2 gx-sm-3">
										<div class="col-5 col-md-4">
											<a class="ani-opa05"
											   href="{$newsRelatedItem.slug|url_technology_detail:$newsRelatedItem.blog_id}"
											   title="{$newsRelatedItem.title|stripslashes}">
										...
										<div class="col-7 col-md-8">
											<h5 class="post-title text-uppercase">
												<a href="{$newsRelatedItem.slug|url_technology_detail:$newsRelatedItem.blog_id}"
