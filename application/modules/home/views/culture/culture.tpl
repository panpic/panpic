            ...
            <div class="row">
                <div class="col-lg-8 order-lg-1">
                    <div class="heading mt-0">
                        <h1 class="heading-title lh-base h3">{$lable.company_culture}</h1>
                    </div>
                    {if $totalItems == 0}
                            ...
                            {foreach from=$news key=$newsKey item=newsItem}
                                {if $newsKey == 0}
                                    <div class="col-12 mb-4">
                                        <h5 class="post-title post-title-lg">
                                            <a href="{$newsItem.slug|url_culture_detail:$newsItem.blog_id}"
                                               title="{$newsItem.title|stripslashes}">{$newsItem.title|stripslashes}</a>
                                        </h5>
                                        ...
                                        <div class="post-thumb my-3">
                                            <a class="ani-opa05"
                                               href="{$newsItem.slug|url_culture_detail:$newsItem.blog_id}"
                                            ...
                                            <p class="post-desc">{$newsItem.short}</p>
                                        </div>
                                    </div>
                                {else}
                                    <div class="col-12 mb-3">
                                        <div class="row gx-2 gx-sm-3">
                                            ...
                                            <div class="col-7 col-md-8">
                                                ...
                                                <p class="post-desc d-none d-sm-block">{$newsItem.short}</p>
                                            </div>
                                        </div>
                                    </div>
                                {/if}
