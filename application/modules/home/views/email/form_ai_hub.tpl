...
@media only screen and (max-width:640px){
	a[href^="tel"], a[href^="sms"]{text-decoration:none;color:#0a8cce; /* or whatever your want */pointer-events:none;cursor:default}
...
@media only screen and (max-width:480px)contact_form_placeholder_phone
	a[href^="tel"], a[href^="sms"]{text-decoration:none;color:#0a8cce; /* or whatever your want */pointer-events:none;cursor:default}
	.mobile_link a[href^="tel"], .mobile_link a[href^="sms"]{text-decoration:default;color:#0a8cce !important;pointer-events:auto;cursor:default}
							...
							<table align="left" class="fn">
								<tr>
									<td width="265" style="padding:18px 0 24px;">
										<a href="{$base_url}" style="outline:none;" title="Thiet ke web PANPIC"><img src="{$base_url}/assets/front/images/logo.png" alt="Logo PANPIC" class="logo-img" style="border:0;display:block;-ms-interpolation-mode:bicubic;">
										</a>
									</td>
								</tr>
							</table>
				...
				<table width="650" align="center" border="0" cellpadding="0" cellspacing="0" class="devicewidth" style="background-color:#f8b92c;">
					<tr>
						<td align="center" class="h6" height="35"
							...
							<span style="text-decoration:none; outline:none;color:#fff;">Thông tin liên hệ tại website PANPIC.vn</span>
						</td>
					</tr>
				</table>
			</td>
							...
							<table width="600" align="center" border="0" cellspacing="0" cellpadding="0" class="devicewidthinner" style="border-collapse:collapse;background-color:#FFFFFF;" background="#fff;">
								<tr>
									...
									<td class="h3 b title-td" style="color:#000000;font-size:14px;font-family:Arial;">
										<table width="580">
											<tr>
												<td><br/>Dear Admin<br/><br/></td>
											</tr>
										</table>
										<br/>
										<table width="580" style=" border-bottom:2px solid #0194E9">
											<tr>
												<td><strong>Thông tin liên hệ trên website PANPIC</strong>:</td>
											</tr>
										</table>
										<br/>
										Thông tin liên hệ:<br/> <br/>
										Tên công ty/Họ tên: {$company_name}<br/>
										Email: {$email}<br/>
										Điện thoại: {$phone}<br/>
										Chọn dịch vụ quan tâm: {$service}<br/>

										Nội dung: {nl2br($message)}<br/>
										Ngày: {$submitted_at}<br/>
										IP address: {$ip_address}<br/>
										<br/>
										<br/>
										Chúc công việc kinh doanh của bạn luôn thành công<br/></td>
									<td width="10">
										<img src="http://dev.panpic.vn/newsletter/html/mailchimp/images/spacer.gif" width="1" height="1" style="border:0;display:block;-ms-interpolation-mode:bicubic;"/>
									</td>
								</tr>
					...
					<tr>
						...
						<td>
							<table width="600" align="center" border="0" cellspacing="0" cellpadding="0" class="devicewidth">
								<tr>
									<td class="h3 b title-td" style="font-family:'Arial'; color:#000; font-size:12px; line-height:30px;">{$email_footer}</td>
								</tr>
								<tr>
