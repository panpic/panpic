...
{if $isMobile eq DETECT_MOBILE || $isMobile eq DETECT_IPAD}<div class="ms-auto"><button class="btn-toggle" id="toggle-menu"><span class="btn-toggle-icon"></span><span class="btn-toggle-text">Menu</span></button></div>{/if}
</div>
</div>
...
<div class="d-flex flex-column align-items-md-end">
	...
	<div class="main-menu" id="main-menu">
		<div class="main-menu-inner">
			...
			{if $isMobile eq DETECT_MOBILE || $isMobile eq DETECT_IPAD}
			<div class="nav-info d-md-none">
				<a class="nav-info-item" href="tel:{$lable.top_hotline}"><i class="bi bi-telephone-fill"></i><span>{$lable.lable_hotline}: {$lable.top_hotline}</span></a><a class="nav-info-item" href="mailto:{$lable.top_email}" title="Gửi email: {$lable.top_email}"><i class="bi bi-envelope-fill"></i><span>Email: {$lable.top_email}</span></a>
			</div>
			{/if}
		</div>
	</div>
