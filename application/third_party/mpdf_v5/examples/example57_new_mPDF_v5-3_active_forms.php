...
application.alert(\'Value of password field is: \\\'\' + npass + \'\\\'\');
var nButton = application.alert({
...
var defaultAnswer = "";
var reply = application.response("This is javascript set to run when the document opens. Enter value for first field", dialogTitle, defaultAnswer);
if (reply != null) { 
