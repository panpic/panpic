...
(function ($, undefined) {
    ...
    MultiSelect2 = clazz(AbstractSelect2, {
        ...
        initContainer: function () {
			...
			//150617
			/*
			$('.select2-results .select2-result .select2-input').mouseout(function(){
			...
			*/
			...
			this.search.bind("keyup", this.bind(
									function(e) {			
											this.resizeSearch;
            ...
            this.search.bind("blur", this.bind(function(e) {
				...
				$('.select2-drop').mouseout(function(){
					//$('.select2-results').css('display','none');
				});
            ...
            this.container.delegate(selector, "focus", this.bind(function () {
				...
				//blockDropDown(); //150616
				
				//$('.select2-drop').attr('id', 'select2-drop');
				//$('.select2-results').css('display','block');
				...
				/*
				$('.select2-results .select2-result').mouseout(function(){
					$('.select2-results').css('display','none');
				});
				*/
			...
			/*
			this.container.delegate(selector, "selecting", this.bind(function () {
                alert(1);
			}));
			
			this.container.delegate(selector, "mouseout", this.bind(function () {
                //alert(1);
			}));
			
			$('#select2_2').on("select2-selecting", function(e) { 
				alert(1);
			});
			*/
    ...
    $.fn.select2 = function () {
        ...
        var args = Array.prototype.slice.call(arguments, 0),
            opts,
            select2,
            value, multiple, allowedMethods = ["val", "destroy", "opened", "open", "close", "focus", "isFocused", "container", "onSortStart", "onSortEnd", "enable", "disable", "positionDropdown", "data", "blur"]; //150615
