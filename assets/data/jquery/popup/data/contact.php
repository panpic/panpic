...
$mEmailDiable = !empty($mEmail) ? 'disabled="disabled"' : '';
// User settings
$to = $mEmail; //"thandongdv2004@yahoo.com";
...
if (empty($action)) {
	...
	<div class='contact-content'>
		<h1 class='contact-title'>Send a message:</h1>
		...
		<form action='#' style='display:none'>
			...
			<input type='text' id='contact-email' class='contact-input' name='email' value='Your mail' tabindex='1002' />";
	...
	<div class='contact-bottom'><a href='mailto:{$mEmail}'>Mail send to: {$mEmail}</a></div>
</div>";
