...
jQuery.fn.prettyGallery = function(settings) {
	...
	return this.each(function(){
		...
		var _applyNav = function() {
			var template = '';
				template +='<ul class="pg_paging" style="clear:both">';
				template += '<li class="pg_previous"><a href="#" title="'+settings.previous_title_label+'" class="back">'+settings.previous_label+'</a></li>';
				template += '<li>'+settings.page_title+' <span class="current">1</span>'+settings.of_label+'<span class="total">1</span></li>';
				template += '<li class="pg_next"><a href="#" title="'+settings.next_title_label+'" class="next">'+settings.next_label+'</a></li>';
				template += '</ul>';
